...
![Entanglement Entropy with Increasing Circuit Depth](img/bonus1.png)

![Entanglement Entropy with Increasing Circuit Depth](img/bonus2.png)
...
![Bond Dimension](img/bonus_dim.png)
...
![Speckle pattern probabilities animation](img/speckle.gif)

We demonstrate the same animation in a single figure shown here:

![Speckle pattern probabilities](img/task-2-speckle-pattern-subplots.svg)

We also show another set as a collection of line graphs:

![Line grap probabilities](img/task-2-probs-line-graph.svg)

And checkout out this heatmap displaying the random probabilities:

![Heatmap](tutorial_heatmap_anim.gif)
...
![Emprical Distribution of Psi](img/task3_1.png)

![Emprical Distribution of Psi](img/task3_2.png)
...
![Linear Fidelity](img/task4_1.png)
...
![QPU Probabilities](img/qpu-histo-deep.png)
...
![QPU CDF](img/qpu-cdf-deep.png)

Compared to the true Porter-Thomas (exponential) distribution: 

![QPU True CDF](img/qpu-true-cdf-deep.png)
